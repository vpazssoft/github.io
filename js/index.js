...
function filterHash(){
    ...
    const textResult = document.getElementById("txtTextFilter").value.replaceAll("SHA-256", "SHA256")
    //filter custom
    ...
    document.getElementById("txtResultCountMD5").value =  "MD5: "+ lineMD5.length

    //count line sha256
    const lineSHA256 = resultSHA256FilterText.split(/\r\n|\r|\n/);
    const countLineSHA256 = lineSHA256.length
    console.log(countLineSHA256)
    document.getElementById("txtResultCountSHA256").value = "SHA256: " + countLineSHA256
    
    //count line custom
    const lineCUSTOM = resultFilterText.split(/\r\n|\r|\n/);
    const countLineCUSTOM = lineCUSTOM.length
    document.getElementById("txtResultCountCUSTOM").value = "FILTRO: " + countLineCUSTOM
}
//line number
